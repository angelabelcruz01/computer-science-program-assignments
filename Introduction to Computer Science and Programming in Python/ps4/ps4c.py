...
class SubMessage(object):
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for c in self.message_text:
            encrypted_text += transpose_dict.get(c,c)
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for p in get_permutations(VOWELS_LOWER):
            decrypted_message = self.apply_transpose(self.build_transpose_dict(p))
            valid_words_count = 0
            ...
            if valid_words_count > max_valid_words:
                ...
                best_decrypted_text = decrypted_message
...
if __name__ == '__main__':
    ...
    # Example test case
    message = SubMessage("Hello My Beautiful World!")
    permutation = "eaiuo"
    ...
    message = SubMessage("She. She is a very good friend.")
    permutation = "aeuio"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "She. She us a very giid fruend.")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())
